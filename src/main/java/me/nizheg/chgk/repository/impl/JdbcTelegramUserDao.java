...
import me.nizheg.chgk.repository.TelegramUserDao;
...
public class JdbcTelegramUserDao implements TelegramUserDao {
    ...
    private SimpleJdbcInsert telegramUserInsert;
    private TelegramUserMapper telegramUserMapper = new TelegramUserMapper();
